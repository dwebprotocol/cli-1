...
import { parseDWebUrl, fromPathToDTreeKeyList } from '../../urls.js'

const FULL_USAGE = `
Examples:

  dweb dtree put dweb://1234..af/foo "hello"
  dweb dtree put dweb://1234..af/foo/bar 12345
  cat data.json | dweb dtree put dweb://1234..af/data
`

export default {
  name: 'dtree put',
  description: 'Set the value of an entry of the given dwebtree URL.',
  usage: {
    simple: '{url} [value]',
    full: FULL_USAGE
  },
