...
import { keyToPath, listShallow } from '../../dwebtree-util.js'
...
Examples:
  ...
  dweb dtree ls dweb://1234..af/
  dweb dtree ls dweb://1234..af/foo/bar
  dweb dtree ls dweb://1234..af/ --gte a --lt m
`

export default {
  name: 'dtree ls',
  description: 'List the entries of the given dwebtree URL.',
  usage: {
    simple: '{url}',
    full: FULL_USAGE
  },
  ...
  command: async function (args) {
    ...
    // ORIGINAL CODE
    // (I'm keeping this for when dwebtree gets shallow readstreams in base)
    // -prf
    // var opts = {}
    ...
    //   pump(
    //     dtree.api.createReadStream(opts),
    ...
    var res = await listShallow(dtree.api, urlp.pathname || '/')
