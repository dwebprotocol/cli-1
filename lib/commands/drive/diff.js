...
Examples:
  ...
  dweb drive diff dweb://1234..af/ ./local-folder
  dweb drive diff ./local-folder dweb://1234..af/remote-folder --no-delete
  dweb drive diff dweb://1234..af/ dweb://fedc..21/ --commit
`

export default {
  name: 'drive diff',
  description: 'Compare two folders in your local filesystem or in dDrives. Can optionally "commit" the difference.',
  usage: {
