...
Examples:
  ...
  dweb drive put dweb://1234..af/hello.txt "Hello world!"
  cat package.json | dweb drive put dweb://1234..af/package.json
  cat photo.png | dweb drive put dweb://1234..af/photo.png
`

export default {
  name: 'drive put',
  description: 'Write a file at the given ddrive URL.',
  usage: {
    simple: '{url} [content]',
    full: FULL_USAGE
  },
